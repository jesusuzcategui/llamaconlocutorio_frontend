export const CUSTOMFORMLC_COUNTRIES_LIST = [
...
export const CUSTOMFORMLC_MEMBERS_LIST = [
    {value: "Amigo", label: "Amigo"},
    {value: "Publicidad por Influencer", label: "Publicidad por Influencer"},
    {value: "Publicidad de Instagram / Facebook", label: "Publicidad de Instagram / Facebook"},
    {value: "Publicidad de Google", label: "Publicidad de Google"},
    {value: "Otro", label: "Otro"}
];

export const CUSTOMFORMLC_PRICE_ONE = [
    {value: "1000 CLP", label: "1000 CLP"},
    {value: "2500 CLP", label: "2500 CLP"},
    {value: "5000 CLP", label: "5000 CLP"},
    {value: "10000 CLP", label: "10000 CLP"}
];

export const CUSTOMFORMLC_PRICE_TWO = [
    {value: "3000 CLP", label: "3000 CLP"},
    {value: "5000 CLP", label: "5000 CLP"},
    {value: "10000 CLP", label: "10000 CLP"},
    {value: "20000 CLP", label: "20000 CLP"},
];

export const WORDPRESS_AJAX_SEND_FORM = "https://locutorios.cl/wp-admin/admin-ajax.php";
export const WORDPRESS_AJAX_HOOK_FORM = "customformlc_submitclient";